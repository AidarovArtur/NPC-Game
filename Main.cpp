...
// Main.cpp (this file) creates an array of objects 'nArr[]' and uses a menu driven program 
...
int addNPC(string nameInput, string occupationInput, int level_input, int health_input);
void sort();
